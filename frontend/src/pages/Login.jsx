...
export default function Login() {
  ...
  return (
    <section className="flex h-screen min-h-[calc(100dvh-80px)] flex-col items-center justify-center font-alt text-light">
      <form
        className="mx-24 flex w-full flex-col gap-8 text-center md:max-w-[500px]"
        onSubmit={handleSubmit}
      >
        <h2 className="text-xl uppercase">Connection</h2>
        <input
          type="email"
          placeholder="Email"
          className="w-full rounded border p-3 text-dark focus:border-primary focus:outline-none"
          id="email-login"
          value={email}
        ...
        <button
          className="text-neutralLight w-full items-center rounded border-0 bg-primary px-3 py-1 text-base hover:bg-primary/75 md:mt-0"
          type="submit"
        >
          Sign in
        </button>
