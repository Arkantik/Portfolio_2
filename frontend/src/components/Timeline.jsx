              ...
              <div className="row align-items-start">
                <div className="col-12 col-md-9 pl-md-0">
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      Joining Amazon as an operations officer marked my first
                      job experience, as the challenging circumstances in the
                      building industry during that time hindered opportunities
                      in that field.
                    </p>
                  </div>
                  <div className="sub-content">
                ...
                <div className="col-12 col-md-9 pl-md-0">
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      opportunity at Chronopost, where I embarked on a new
                  ...
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      smooth operations. I also actively engaged in sales as
                      well as facilitating the convenient pickup of packages
                      directly from their offices. I played a crucial role in
                      maintaining customer satisfaction by liaising with our
                      dedicated customer service team which required my
                ...
                <div className="col-12 col-md-9 pl-md-0">
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      operations officer, I was delighted to receive an offer
                      for a permanent position, solidifying my commitment to the
                  ...
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      aligned with my previous position. I continued to manage
                      drivers, enforce procedures, and ensure seamless
                      operations. Additionally, I undertook the crucial
                      responsibility of overseeing all export packages from the
                      office, meticulously examining accompanying documentation,
                      verifying compliance, and effectively communicating the
                      required documents to customs at Roissy Charles de Gaulle
                      airport. I handled hazardous material shipments on
                      occasion, adhering strictly to IATA (International Air
                ...
                <div className="col-12 col-md-9 pl-md-0">
                  ...
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      and inquiries. Additionally, I oversaw driver management
                      and conducted regular audits to evaluate their
                      performance. Another aspect of my role involved handling
                      billing, ensuring accurate and timely invoicing. Lastly, I
                      was involved in fleet management, overseeing the
                      administration and maintenance of the vehicle fleet. These
                      responsibilities developed my skills in analysis, customer
                ...
                <div className="col-12 col-md-12 pl-md-0">
                  ...
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      operations team. I also excelled in optimizing driver
                      route network costs, contributing to cost-effective
                      operations. Moreover, I played a key role in training and
                      mentoring new operators, ensuring adherence to operating
                      procedures. <br />
                      ...
                      performance to maintain high-quality standards. These
                      skills in analysis, optimization, training, and management
                      are transferable and valuable in various industries.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col-12 col-md-9 pl-md-0">
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      career i wasn't able to go deeper on the subject. In
                      summer 2021, i decided to return to crypto with the wish
                      to join a project.
                    </p>
                  </div>
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      improve the public image and reputation of Avian Network,
                      a very new crypto project. <br />I developped PR
                      campaigns, built relationships with youtubers &amp;
                      community members, and communicated key messages
                      effectively. My goal was to shape perception, build trust,
                      and maintain positive community relationships together
                      with the PR team.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-12 col-md-12 pl-md-0">
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      growing up, a role of Project Coordinator opened up. This
                      new position was for me the opportunity to learn more
                      about crypto but also about managing a projet and bring it
                  ...
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      ...
                      my focus was on driving the project efficiency,
                      maintaining clear communication, and supporting the team
              ...
              <div className="row align-items-start">
                <div className="col-12 col-md-12 pl-md-0">
                  ...
                  <div className="sub-content">
                    ...
                    <p className="alt-font">
                      I have acquired a diverse set of skills that have shaped
                      my professional and personnal growth. This include project
                      management, communication, team work, adaptability to
                      changing environments, stakeholder relationship
                      management, problem-solving.
                      <br />
                      Additionally, I have honed my abilities in coordinating
                      team efforts, managing timelines, and navigating the
                      challenges inherent in the ever-evolving crypto landscape.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col-12 col-md-9 pl-md-0">
                  <div className="sub-content">
                    <p className="alt-font">
                      ...
                      industry, I decided to pursue my true passion and embark
                      on a journey into web development. To kickstart this
                      transition, I made the decision to join a 5-month
                      intensive training program at Wild Code School. This
                      experience allowed me to acquire the foundations of web
                      development and expand my knowledge in this exciting
                      domain. <br />
                      With a solid background in problem-solving and attention
                      to detail from my previous industry, I now bring a fresh
                      perspective to the field of web development. I am
                      dedicated to crafting innovative and user-centric
                      solutions, leveraging my diverse background to create
                      impactful digital experiences. Ready to take on new
